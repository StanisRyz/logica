...
/**
 * One calm slate palette for the whole product. Every role is defined explicitly: leaving the
 * container and surface roles at their Material baseline mixed a second, unrelated hue into cards,
 * Crowns regions, and Word feedback.
 */
...
/** One corner treatment for the whole product; cards and dialogs inherit `medium`. */
...
fun LogicaTheme(
    ...
    CompositionLocalProvider(
        LocalLogicaPalette provides if (useDarkTheme) DarkLogicaPalette else LightLogicaPalette,
    ) {
        MaterialTheme(
