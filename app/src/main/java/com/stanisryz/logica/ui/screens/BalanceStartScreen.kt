...
fun BalanceStartScreen(
    ...
    Column(
        ...
        Text(stringResource(R.string.balance), style = MaterialTheme.typography.headlineMedium)
        Text(stringResource(R.string.balance_rules_summary), style = MaterialTheme.typography.bodyLarge)
        ...
        if (!tutorialCompleted) {
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Text(stringResource(R.string.balance_tutorial_offer_body))
...
@Composable
internal fun Difficulty.russianLabel(): String =
    stringResource(
        when (this) {
