...
import com.stanisryz.logica.puzzle.core.internal.PlatformSynchronized
import com.stanisryz.logica.puzzle.core.internal.Sha256
...
class BinarySudokuDataset(
    ...
    private class Bucket(
        ...
        fun parseRecord(index: Int): SudokuDatasetResult<SudokuPuzzle> {
            ...
            if (!Sha256.digest(givens.encodeToByteArray()).contentEquals(fingerprintBytes)) {
    ...
    private companion object {
        val MAGIC = "LOGSDK01".encodeToByteArray()
